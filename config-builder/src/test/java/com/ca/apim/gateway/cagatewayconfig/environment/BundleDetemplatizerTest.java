...
class BundleDetemplatizerTest {
    ...
    private final String bundleXml = "<l7:Bundle xmlns:l7=\"http://ns.l7tech.com/2010/04/gateway-management\">\n" +
            "    <l7:References>\n" +
            "        <l7:Item>\n" +
    ...
    private final String bundleXmlWithJmsRoutingAssertion = "<l7:Bundle xmlns:l7=\"http://ns.l7tech.com/2010/04/gateway-management\">\n" +
            "    <l7:References>\n" +
            "        <l7:Item>\n" +
            "            <l7:Name>my-gateway-api</l7:Name>\n" +
            "            <l7:Id>8263a394a3782fa4984bcffc2363b8db</l7:Id>\n" +
            ...
            "            &lt;L7p:EndpointName stringValue=\"test-JMS\"/&gt;\n" +
    ...
    @Test
    void detemplatizeJmsRoutingAssertion() {
        String jmsDestGoid = "8163a394a3782fa4984bcffc2363b8ff";
        Bundle bundle = new Bundle();
        bundle.putAllJmsDestinations(ImmutableMap.of("test-JMS", new JmsDestination.Builder().id(jmsDestGoid).build()));
        BundleDetemplatizer bundleDetemplatizer = new BundleDetemplatizer(bundle);

        String detemplatizedJmsBundleXml = bundleDetemplatizer.detemplatizeBundleString(bundleXmlWithJmsRoutingAssertion).toString();
        ...
        assertEquals("<l7:Bundle xmlns:l7=\"http://ns.l7tech.com/2010/04/gateway-management\">\n" +
                ...
                "    &lt;wsp:All wsp:Usage=\"Required\"&gt;\n" +
                "        &lt;L7p:JmsRoutingAssertion&gt;\n" +
                "            &lt;L7p:EndpointOid goidValue=\"" + jmsDestGoid + "\"/&gt;" + "&lt;L7p:EndpointName stringValue=\"test-JMS\"/&gt;\n" +
                "            &lt;L7p:RequestJmsMessagePropertyRuleSet jmsMessagePropertyRuleSet=\"included\"&gt;\n" +
                "                &lt;L7p:Rules jmsMessagePropertyRuleArray=\"included\"/&gt;\n" +
                "            &lt;/L7p:RequestJmsMessagePropertyRuleSet&gt;\n" +
                "            &lt;L7p:ResponseJmsMessagePropertyRuleSet jmsMessagePropertyRuleSet=\"included\"&gt;\n" +
                ...
                "        <l7:Mapping action=\"NewOrUpdate\" srcId=\"8263a394a3782fa4984bcffc2363b8db\" type=\"SERVICE\"/>\n" +
                "    </l7:Mappings>\n" +
                "</l7:Bundle>", detemplatizedJmsBundleXml);
    }
    
    @Test
    void detemplatizeJmsRoutingAssertionMissingEnv() {
        Bundle bundle = new Bundle();
        BundleDetemplatizer bundleDetemplatizer = new BundleDetemplatizer(bundle);
        assertThrows(BundleDetemplatizeException.class, () -> bundleDetemplatizer.detemplatizeBundleString(bundleXmlWithJmsRoutingAssertion));
    }
}

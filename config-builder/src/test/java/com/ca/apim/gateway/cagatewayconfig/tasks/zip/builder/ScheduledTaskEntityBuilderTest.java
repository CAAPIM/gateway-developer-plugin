...
class ScheduledTaskEntityBuilderTest {
    ...
    void buildWithNoPolicy() {
        ...
        assertThrows(EntityBuilderException.class, () -> buildBundleWithScheduledTask(bundle, DEPLOYMENT, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_SCHEDULED_TASK, false));
    }
    ...
    void buildDeploymentWithOneTimeScheduledTask() {
        ...
        buildBundleWithScheduledTask(bundle, DEPLOYMENT, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_SCHEDULED_TASK, true);
    }
    ...
    void buildEnvironmentWithOneTimeScheduledTask() {
        final Bundle bundle = new Bundle();
        putPolicy(bundle, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_POLICY_PATH);
        buildBundleWithScheduledTask(bundle, ENVIRONMENT, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_SCHEDULED_TASK, true);
    }
    ...
    void buildDeploymentWithRecurringScheduledTask() {
        final Bundle bundle = new Bundle();
        putPolicy(bundle, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_POLICY_PATH);
        buildBundleWithScheduledTask(bundle, DEPLOYMENT, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_SCHEDULED_TASK, false);
    }
    ...
    void buildEnvironmentWithRecurringScheduledTask() {
        final Bundle bundle = new Bundle();
        putPolicy(bundle, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_POLICY_PATH);
        buildBundleWithScheduledTask(bundle, ENVIRONMENT, TEST_POLICY_PATH, TEST_POLICY_ID, TEST_SCHEDULED_TASK, false);
    }

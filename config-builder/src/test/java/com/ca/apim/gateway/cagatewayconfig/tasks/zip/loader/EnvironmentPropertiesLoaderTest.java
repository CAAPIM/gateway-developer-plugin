...
class EnvironmentPropertiesLoaderTest {
    ...
    void loadFromEnvironment() {
        EnvironmentPropertiesLoader loader = new EnvironmentPropertiesLoader(fileUtils);
        ...
        // Prop1
        final String prop1 = bundle.getEnvironmentProperties().get(PROP_1);
        assertNotNull(prop1);
    ...
    void loadFileWithSpecifiedProperties() throws IOException {
        ...
        // Prop2
        final String prop2 = bundle.getEnvironmentProperties().get(PROP_2);
        assertNotNull(prop2);
        assertEquals("value2", prop2);

        // Prop3
        final String prop3 = bundle.getEnvironmentProperties().get(PROP_3);
        assertNotNull(prop3);

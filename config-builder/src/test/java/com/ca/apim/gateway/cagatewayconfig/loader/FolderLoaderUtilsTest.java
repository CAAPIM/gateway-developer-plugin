...
import static com.ca.apim.gateway.cagatewayconfig.loader.FolderLoaderUtils.*;
...
class FolderLoaderUtilsTest {
    ...
    void getPolicyRootDirPolicyFileErrorTest(TemporaryFolder temporaryFolder) throws IOException {
        ...
        assertThrows(BundleLoadException.class, () -> getPolicyRootDir(temporaryFolder.getRoot()));
    }

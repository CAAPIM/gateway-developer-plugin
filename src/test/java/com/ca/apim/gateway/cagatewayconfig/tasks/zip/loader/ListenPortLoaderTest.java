...
import static com.ca.apim.gateway.cagatewayconfig.tasks.zip.beans.ListenPort.Feature.MESSAGE_INPUT;
import static com.ca.apim.gateway.cagatewayconfig.tasks.zip.beans.ListenPort.ListenPortTlsSettings.TLSV12;
import static com.ca.apim.gateway.cagatewayconfig.tasks.zip.beans.ListenPort.PROTOCOL_HTTPS;
...
class ListenPortLoaderTest {
    ...
    private static void checkListenPort(Bundle bundle) {
        ...
        assertEquals(PROTOCOL_HTTPS, listenPort.getProtocol(), "Protocol is not HTTPS");
        ...
        assertTrue(listenPort.getEnabledFeatures().contains(MESSAGE_INPUT.getDescription()), "Feature list does not contain " + MESSAGE_INPUT.getDescription());
        assertNotNull(listenPort.getTlsSettings(), "TLS Settings not loaded");
        assertEquals(listenPort.getTlsSettings().getClientAuthentication(), ClientAuthentication.REQUIRED, "Client authentication is not REQUIRED");
        ...
        assertTrue(listenPort.getTlsSettings().getEnabledVersions().contains(TLSV12), "TLS Version enabled is not 1.2");

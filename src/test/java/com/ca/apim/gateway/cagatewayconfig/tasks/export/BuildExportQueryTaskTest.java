...
import com.ca.apim.gateway.cagatewayconfig.util.http.GatewayClient;
...
public class BuildExportQueryTaskTest {
    ...
    public void before() {
        ...
        Mockito.when(gatewayClient.makeGatewayAPICallsWithReturn(Mockito.any(), Mockito.anyString(), Mockito.anyString())).then(invocation -> {
            GatewayClient.APICall apiCall = invocation.getArgumentAt(0, GatewayClient.APICall.class);

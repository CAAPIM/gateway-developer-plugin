...
@Ignore
public class CAGatewayConfigTest {
    private static final Logger LOGGER = Logger.getLogger(CAGatewayConfigTest.class.getName());
    ...
    public void testExampleProject() throws IOException, URISyntaxException {
        ...
        assertEquals(TaskOutcome.SUCCESS, Objects.requireNonNull(result.task(":sanitize")).getOutcome());
    }
}